...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#09083b] text-gray-300'>
        <div>
        ...
        <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#09083b] flex flex-col justify-center items-center'}>
